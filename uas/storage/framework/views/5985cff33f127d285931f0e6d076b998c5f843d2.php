<?php $__env->startSection('content'); ?>
	<form method="POST" action="<?php echo e(URL('/update/'.$tampil_id->id)); ?>">
    ...
    <div class="row">
		...
		<table border="2" width="20%" align="center">
			<tr>
			  ...
			  <td><Input style="text" name="nama" size="50" value="<?php echo e($tampil_id->nama); ?>" /></td>
			</tr>
			<tr>
				<td bgcolor="#00FFFF"><strong>NIM</strong></td>
			  <td><input type=" text" name="nim" size="50" value="<?php echo e($tampil_id->nim); ?>"></td>
			</tr>
			<tr>
				<td bgcolor="#00FFFF"><strong>Alamat</strong></td>
			  <td><input type=" text" name="alamat" size="50" value="<?php echo e($tampil_id->alamat); ?>"></td>
			</tr>
